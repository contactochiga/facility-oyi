...
const ROLE_PERMISSIONS: Record<string, readonly PermissionKey[]> = {
  ...
  estate_admin: ["estates.read", "estates.write", "homes.read", "homes.write", "devices.read", "devices.control", "cameras.view", "visitors.create", "visitors.manage", "wallets.read", "wallets.manage", "services.read", "services.pay", "services.manage", "support.read", "support.assign", "staff.manage", "settings.manage", "community.read", "community.write", "community.moderate", "community.broadcast", "community.manage_announcements", "notifications.read", "notifications.manage"],
  facility_manager: ["estates.read", "estates.write", "homes.read", "homes.write", "devices.read", "devices.control", "cameras.view", "visitors.manage", "wallets.read", "services.read", "services.pay", "services.manage", "support.read", "support.assign", "staff.manage", "community.read", "community.write", "community.moderate", "community.broadcast", "community.manage_announcements", "notifications.read", "notifications.manage"],
  security_operator: ["estates.read", "homes.read", "devices.read", "devices.control", "cameras.view", "visitors.create", "visitors.manage", "support.read", "notifications.read", "notifications.manage"],
  maintenance_operator: ["estates.read", "homes.read", "devices.read", "devices.control", "support.read", "support.assign", "notifications.read"],
  finance_operator: ["estates.read", "homes.read", "wallets.read", "wallets.manage", "services.read", "services.pay", "services.manage", "documents.generate", "support.read", "notifications.read"],
  ...
  ochiga_staff: ["office.read", "estates.read", "homes.read", "devices.read", "cameras.view", "support.read", "support.assign", "documents.generate", "community.read", "community.moderate", "notifications.read", "notifications.manage"],
};
