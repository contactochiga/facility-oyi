...
export const FACILITY_MODULES: ModuleDefinition[] = [
  ...
  { key: "estate-structure", label: "Estate Structure", href: "/estate-structure", startsWith: ["/estate-structure", "/homes", "/occupancy"], anyOf: ["homes.read", "estates.read"] },
  { key: "hardware-devices", label: "Hardware Devices", href: "/hardware-devices", startsWith: ["/hardware-devices", "/devices"], anyOf: ["devices.read"] },
  ...
  { key: "utilities", label: "Utilities", href: "/utilities", startsWith: ["/utilities", "/water"], anyOf: ["devices.read", "estates.read"] },
