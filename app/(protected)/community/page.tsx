  ...
  return (
    <div className="space-y-6">
      ...
      <OisPageToolbar
        ...
        bulkSlot={<Button onClick={() => openCompose()} disabled={!canWrite && !canBroadcast} className="gap-2"><Megaphone className="h-4 w-4" />Create announcement</Button>}
        onRefresh={() => void load()}
        refreshing={loading}
        searchPlaceholder="Community signals load from estate and moderation sources."
      />
