...
export default function Button({
  ...
  const base =
    "inline-flex h-10 items-center justify-center rounded-[10px] px-3.5 py-2 text-sm font-medium transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed";
