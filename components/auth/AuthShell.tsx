...
export function AuthShell({
  ...
  return (
    <div className="min-h-[100dvh] overflow-x-hidden bg-zinc-950 text-white">
      ...
      <div className="relative z-10 flex min-h-[100dvh] items-center justify-center px-5 py-[calc(28px+env(safe-area-inset-top))] pb-[calc(28px+env(safe-area-inset-bottom))]">
