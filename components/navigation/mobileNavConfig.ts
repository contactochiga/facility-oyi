...
export const facilityMobileModules: MobileModuleItem[] = [
  ...
  { key: "estate-structure", label: "Registry", href: "/estate-structure", icon: Building2, activeRoutes: ["/estate-structure", "/homes", "/occupancy"] },
  { key: "hardware-devices", label: "Infra", href: "/hardware-devices", icon: Cpu, activeRoutes: ["/hardware-devices", "/devices"] },
  ...
  { key: "utilities", label: "Utility", href: "/utilities", icon: Droplets, activeRoutes: ["/utilities", "/water"] },
  { key: "traffic-mobility", label: "Gate Flow", href: "/traffic", icon: Car, activeRoutes: ["/traffic"] },
  { key: "maintenance", label: "Continuity", href: "/maintenance", icon: Wrench, activeRoutes: ["/maintenance", "/alerts"] },
  { key: "community", label: "Signals", href: "/community", icon: MessageSquare, activeRoutes: ["/community", "/messages"] },
  { key: "wallets", label: "Financial", href: "/wallets", icon: FileText, activeRoutes: ["/wallets", "/services"] },
];
...
export const officeMobileModules = [
  ...
  { key: "devices", label: "Infrastructure Registry", target: "devices", focus: "devices", icon: Cpu },
  ...
  { key: "team", label: "Governance", target: "team", focus: "staff_roles", icon: UserRoundCog },
