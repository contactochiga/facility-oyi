...
export const facilityMobileModules: MobileModuleItem[] = [
  ...
  { key: "security-access", label: "Security", href: "/security-access", icon: iconForModule("security-access"), activeRoutes: ["/security-access", "/security", "/cameras"] },
  ...
  { key: "traffic-mobility", label: "Access", href: "/traffic", icon: iconForModule("traffic-mobility"), activeRoutes: ["/traffic", "/visitors"] },
