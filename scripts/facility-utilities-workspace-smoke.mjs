...
assert.match(page,/facility:realtime-event/);assert.match(page,/UtilitiesRegistryWorkspace/);assert.match(page,/OisDrawer/);assert.doesNotMatch(page,/Calorie Block|IKEDC|Spectranet|₦12,450/);assert.doesNotMatch(page,/password|access_token|secret|token_code/);
